...
import com.example.bookclub.adapters.ChatAdapter;
...
public class MessagingActivity extends AppCompatActivity {
    ...
    String TAG = "MessagingActivityClass";
    ...
    void setupMessagePosting() {
        ...
        mAdapter = new ChatAdapter(MessagingActivity.this, userId, mMessages);
        rvChat.setAdapter(mAdapter);

        // associate the LayoutManager with the RecylcerView
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MessagingActivity.this);
