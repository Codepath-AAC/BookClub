...
public class BookAdapter7 extends RecyclerView.Adapter<BookAdapter7.ViewHolder> {
    ...
    private ArrayList<Book7> mBooks = new ArrayList<>();
    private Context mContext;
    private OnItemClickListener listener;

    public BookAdapter7(Context context, ArrayList<Book7> book7s) {
        mContext = context;
        mBooks = book7s;
    }
    ...
    public BookAdapter7(ArrayList<Book7> books, ArrayList<String> abookNames, ArrayList<String> abookImageUrls, Context context) {
    ...
    @NonNull
    @Override
    public BookAdapter7.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        View view = inflater.inflate(R.layout.layout_bookitem, parent, false);

        BookAdapter7.ViewHolder viewHolder = new BookAdapter7.ViewHolder(view, listener);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull BookAdapter7.ViewHolder holder, int position) {
        Log.d(TAG, "onBindViewHolder: called");

        Book7 book = mBooks.get(position);
